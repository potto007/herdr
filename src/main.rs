...
# or "user_ordered" (the order you dragged rows into in the agents panel).
# "workspaces" is accepted as an alias for "spaces", "manual" for "user_ordered".
# Dragging an agent row selects "user_ordered" on its own.
